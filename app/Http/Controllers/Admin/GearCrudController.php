...
/**
 * Class GearCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class GearCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Gear::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/gear');
        CRUD::setEntityNameStrings('gear', 'gears');
    }
